...
class ErrorOnSubmitSMSC(HappySMSC):
    ...
    def handleSubmit(self, reqPDU):
        print "Sending unexpected Command status"
        self.sendResponse(reqPDU, CommandStatus.ESME_RESERVER_ERROR)
...
if __name__ == '__main__':
    ...
    factory          = Factory()
    factory.protocol = ErrorOnSubmitSMSC
    print "Listen SMPP at :8007"
